    ...
    <div className="page-container">
      <header className="navbar">
        ...
        <nav className="nav-links">
          <Link to="/">Home</Link>
          <Link to="/guidlines">Guidelines</Link> {/* Link to Guidelines */}
        </nav>
...
<div className="about-section">
  ...
  <p>
    Welcome to Research Odyssey, a platform designed to make your research journey easy and enjoyable. 
    Our goal is to provide a seamless experience for researchers, students, and reviewers by offering 
    tools and resources to explore, upload, and share research work. Join us in shaping the future of 
        ...
        <div className="footer-content">
          <div className="footer-heading">
            ...
            <div className="footer-mails">
              ...
              <p><a href="2300030732@kluniversity.in">2300030732@kluniversity.in</a></p>
              <p><a href="2300030544@kluniversity.in">2300030544@kluniversity.in</a></p>
              <p><a href="2300030461@kluniversity.in">2300030461@kluniversity.in</a></p>
              <p>
    <Link to="/feedback" className="feedback-link">Give Us Your Feedback</Link> {/* Link to Feedback Page */}
  </p>
            </div>
            <div>
              <h2>Phone Numbers</h2>
